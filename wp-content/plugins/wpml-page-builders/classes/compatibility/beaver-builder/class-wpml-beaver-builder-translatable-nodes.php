		...
		$this->nodes_to_translate = array(
			...
			'button'         => array(
				...
				'fields'     => array(
					...
					array(
						'field'       => 'link',
						'type'        => __( 'Link', 'wpml-page-builders' ),
						'editor_type' => 'LINK'
					),
				),
			),
			...
			'call to action' => array(
				...
				'fields'     => array(
					array(
						'field'       => 'title',
						'type'        => __( 'Call to Action: Heading', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'text',
						'type'        => __( 'Call to Action: Text', 'wpml-page-builders' ),
						'editor_type' => 'VISUAL'
					),
					array(
						'field'       => 'btn_text',
						'type'        => __( 'Call to Action: Button text', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'btn_link',
						'type'        => __( 'Call to Action: Button link', 'wpml-page-builders' ),
						'editor_type' => 'LINK'
					),
			...
			'icon'           => array(
				...
				'fields'     => array(
					array(
						'field'       => 'text',
						'type'        => __( 'Icon text', 'wpml-page-builders' ),
						'editor_type' => 'VISUAL'
					),
					array(
						'field'       => 'link',
			...
			'callout'        => array(
				...
				'fields'     => array(
					array(
						'field'       => 'title',
						'type'        => __( 'Callout: Heading', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'text',
						'type'        => __( 'Callout: Text', 'wpml-page-builders' ),
						'editor_type' => 'VISUAL'
					),
					array(
						'field'       => 'cta_text',
						'type'        => __( 'Callout: Call to action text', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'link',
						'type'        => __( 'Callout: Link', 'wpml-page-builders' ),
						'editor_type' => 'LINK'
					),
				),
			),
			'contact-form'   => array(
				...
				'fields'     => array(
					array(
						...
						'type'        => __( 'Contact Form: Success message', 'wpml-page-builders' ),
						'editor_type' => 'VISUAL'
					),
					array(
						'field'       => 'btn_text',
						'type'        => __( 'Contact Form: Button text', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'success_url',
						'type'        => __( 'Contact Form: Redirect link', 'wpml-page-builders' ),
						'editor_type' => 'LINK'
					),
				),
			),
			'numbers'   => array(
				...
				'fields'     => array(
					array(
						...
						'type'        => __( 'Number Counter: Text before number', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'after_number_text',
						'type'        => __( 'Number Counter: Text after number', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
				),
			),
			...
			'testimonials'            => array(
				...
				'fields'            => array(
					array(
						'field'       => 'heading',
						'type'        => __( 'Testimonial heading', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
			...
			'subscribe-form'        => array(
				...
				'fields'     => array(
					array(
						'field'       => 'success_message',
						'type'        => __( 'Subscribe form: Success message', 'wpml-page-builders' ),
						'editor_type' => 'VISUAL'
					),
					array(
						'field'       => 'btn_text',
						'type'        => __( 'Subscribe form: Button text', 'wpml-page-builders' ),
						'editor_type' => 'LINE'
					),
					array(
						'field'       => 'success_url',
						'type'        => __( 'Subscribe form: Redirect link', 'wpml-page-builders' ),
						'editor_type' => 'LINK'
					),
				),
			),
