...
class WPML_Elementor_Price_List extends WPML_Elementor_Module_With_Items {
	...
	protected function get_title( $field ) {
		if ( 'title' === $field ) {
			return esc_html__( 'Price list: title', 'wpml-page-builders' );
		}

		if ( 'item_description' === $field ) {
			return esc_html__( 'Pricing list: description', 'wpml-page-builders' );
		}

		if ( 'url' === $field ) {
			return esc_html__( 'Pricing list: link', 'wpml-page-builders' );
		}
